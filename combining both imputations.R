...
policy_df$deductibleamountincontentscoverage[is.na(policy_df$deductibleamountincontentscoverage)]=median(policy_df$deductibleamountincontentscoverage,na.rm=TRUE)
head(policy_df$deductibleamountincontentscoverage)
sum(is.na(policy_df$deductibleamountincontentscoverage))
...
policy_df$deductibleamountinbuildingcoverage[is.na(policy_df$deductibleamountinbuildingcoverage)]=median(policy_df$deductibleamountinbuildingcoverage,na.rm=TRUE)
head(policy_df$deductibleamountinbuildingcoverage)
sum(is.na(policy_df$deductibleamountinbuildingcoverage))
