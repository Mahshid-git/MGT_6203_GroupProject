...
pcr.model = pcr(totalinsurancepremiumofthepolicy ~., data = train, validation = "CV", )

```


```{r}
validationplot(pcr.model, val.type="MSEP", main = "Premium Insurance of Policy", ylab = "Mean Squared Error")
