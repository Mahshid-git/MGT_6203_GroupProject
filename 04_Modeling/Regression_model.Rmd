...
```{r}
v1 <- ggplot(df) +
  geom_boxplot(aes(y=totalinsurancepremiumofthepolicy, x=basementenclosurecrawlspacetype, fill=basementenclosurecrawlspacetype), show.legend=FALSE) +
...
v3 <- ggplot(df) +
  geom_boxplot(aes(y=totalinsurancepremiumofthepolicy, x=deductibleamountinbuildingcoverage, fill=deductibleamountinbuildingcoverage), show.legend = FALSE) +
   xlab("deductibleamountinbuildingcoverage") +
  ylab("Premium Price")

v4 <- ggplot(df) +
  geom_boxplot(aes(y=totalinsurancepremiumofthepolicy, x=deductibleamountincontentscoverage, fill=deductibleamountincontentscoverage), show.legend = FALSE) +
   xlab("deductibleamountincontentscoverage") +
  ylab("Premium Price")
