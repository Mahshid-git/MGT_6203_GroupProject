...
```{r}
final_data<- cbind(Actual = test$totalinsurancepremiumofthepolicy, Predicted = lm_pred)
View(final_data)
```

```{r}
actuals_preds <- data.frame(final_data)
...
# => 82.7%, mean absolute percentage deviation
