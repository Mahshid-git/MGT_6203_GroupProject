...
#repeat the above for df_poilicymode
#factor the locationofcontents column 
...
#repeat for dfmode
#identify all character columns
dfmode2 <- subset(dfmode1, select = -c(floodzone))
#convert all character columns to numeric
...
# repeat for dfmode2
dfmode2 <- dfmode2[dfmode2$policycost >= 0, ]
...
```{r}
# As the number of totalinsurancepremiumofthepolicy > 3000 is only 0.1% then we remove all rows with the value higher than 5000 to eleminate error
