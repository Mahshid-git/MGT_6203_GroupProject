...
```{r}
df_final <- subset(df_clean, select = -c(censustract, policytermindicator, basementonly, mobilehomeortrailer, floodzone_highrisk, floodzone_modrisk, floodzone_undetermined, policyterminationdate, not_condo, u_condo, policyeffectivedate, crsdiscount))
...
file_path3 <- "../03_EDA/df_final_NoNA.parquet"
...
file_path <- "../03_EDA/df_final_NoNA.parquet"
df <- read_parquet(file_path, as_tibble = TRUE)
